...
export default function OriginPage() {
  ...
  // ─── Cosmic Sync (Dynamic Island Bridge) ───
  // Note: We no longer trigger launch here directly. 
  // NeuralCore now listens for COSMOS_NAVIGATE and triggers the sequence.
  // This listener is preserved for potential future planetary status sync.
  useEffect(() => {
    // NeuralCore internally calls handlePortalLaunch via onPortalLaunch prop
  }, []);
    ...
    <div ref={containerRef} className="relative w-full h-[100vh] bg-[#020108] overflow-hidden font-sans">
      ...
      >
        ...
        <div className="mt-10 flex items-center gap-4 opacity-50">
          ...
          <span className="text-[8px] text-white uppercase tracking-[0.35em] font-bold">Click planet to launch</span>
        </div>
      </motion.div>
