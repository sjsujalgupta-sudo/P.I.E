 ...
 * It handles user interactions, communicates with the background script,
 * and manages the UI state.
 *
 * Responsibilities:
 * - Initialize popup when opened
 * - Handle start/stop session buttons
 * - Display session status and ID
 * - Show data preview
 * - Trigger data exports
 *
 * For beginners: This is the "remote control" for the popup interface.
 * It connects the buttons you click to the actions that happen.
 */
