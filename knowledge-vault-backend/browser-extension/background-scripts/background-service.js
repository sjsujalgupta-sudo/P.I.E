...
//
// This script runs in the background and coordinates the extension's activities.
// It handles communication between the popup, content scripts, and the backend server.
// Think of it as the "manager" that oversees all extension operations.
//
// Key responsibilities:
// - Start/stop data collection sessions
// - Receive data from content scripts
// - Send data to the backend server
// - Manage extension settings and state
...
/**
 * Gets the current session state from browser storage
 */
...
/**
 * Saves session state to browser storage
 */
